...
struct Permutation {
  ...
  bool operator==(Permutation y) { return data.getCol(0) == y.data.getCol(0); }
...
// without overflow.
// TODO: need pivoting!!!
// llvm::Optional<std::pair<SquareMatrix<Rational>,llvm::SmallVector<size_t>> lufact(SquareMatrix<intptr_t> &B) {
