...
#ifndef NDEBUG
                minOmegaCoefInd =
                    std::min(minOmegaCoefInd, size_t(edge.out->omegaOffset));
                maxOmegaCoefInd =
...
#ifndef NDEBUG
                minOmegaCoefInd =
                    std::min(minOmegaCoefInd, size_t(edge.in->omegaOffset));
                maxOmegaCoefInd =
                    std::max(maxOmegaCoefInd, size_t(edge.in->omegaOffset));
#endif
            }
