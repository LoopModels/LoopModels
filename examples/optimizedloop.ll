...
define i64 @julia_optimizedloop_34(i64 signext %0) local_unnamed_addr #0 !dbg !5 {
top:
...
define nonnull {} addrspace(10)* @jfptr_optimizedloop_35({} addrspace(10)* nocapture readnone %0, {} addrspace(10)** nocapture readonly %1, i32 %2) local_unnamed_addr #1 {
top:
  ...
  %8 = tail call i64 @julia_optimizedloop_34(i64 signext %7) #0
...
!4 = !{}
!5 = distinct !DISubprogram(name: "optimizedloop", linkageName: "julia_optimizedloop_34", scope: null, file: !3, line: 2, type: !6, scopeLine: 2, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
