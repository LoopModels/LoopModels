...
define i64 @julia_dot_123({} addrspace(10)* nonnull align 16 dereferenceable(40) %0, {} addrspace(10)* nonnull align 16 dereferenceable(40) %1) local_unnamed_addr #0 !dbg !5 {
top:
...
L40:                                              ; preds = %top
  %18 = tail call cc37 nonnull {} addrspace(10)* bitcast ({} addrspace(10)* ({} addrspace(10)*, {} addrspace(10)**, i32)* @jl_apply_generic to {} addrspace(10)* ({} addrspace(10)*, {} addrspace(10)*)*)({} addrspace(10)* addrspacecast ({}* inttoptr (i64 139756642611216 to {}*) to {} addrspace(10)*), {} addrspace(10)* addrspacecast ({}* inttoptr (i64 139756790818256 to {}*) to {} addrspace(10)*)), !dbg !10
...
define nonnull {} addrspace(10)* @jfptr_dot_124({} addrspace(10)* nocapture readnone %0, {} addrspace(10)** nocapture readonly %1, i32 %2) local_unnamed_addr #1 {
top:
  ...
  %7 = tail call i64 @julia_dot_123({} addrspace(10)* %4, {} addrspace(10)* %6) #0
...
!4 = !{}
!5 = distinct !DISubprogram(name: "dot", linkageName: "julia_dot_123", scope: null, file: !3, line: 25, type: !6, scopeLine: 25, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
