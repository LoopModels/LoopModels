...
define void @"julia_nestedloop_2!_152"({} addrspace(10)* nonnull align 16 dereferenceable(40) %0, i64 signext %1) local_unnamed_addr #0 !dbg !5 {
top:
...
define nonnull {} addrspace(10)* @"jfptr_nestedloop_2!_153"({} addrspace(10)* nocapture readnone %0, {} addrspace(10)** nocapture readonly %1, i32 %2) local_unnamed_addr #1 {
top:
  ...
  tail call void @"julia_nestedloop_2!_152"({} addrspace(10)* %4, i64 signext %9) #0
...
!4 = !{}
!5 = distinct !DISubprogram(name: "nestedloop_2!", linkageName: "julia_nestedloop_2!_152", scope: null, file: !3, line: 53, type: !6, scopeLine: 53, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
