; ModuleID = 'nestedloop_1.ll'
source_filename = "nestedloop_1!"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128-ni:10:11:12:13"
target triple = "x86_64-unknown-linux-gnu"

define void @"julia_nestedloop_1!_148"({} addrspace(10)* nonnull align 16 dereferenceable(40) %0, i64 signext %1) local_unnamed_addr #0 !dbg !5 {
top:
...
L48.loopexit:                                     ; preds = %idxend17
  br label %L48, !dbg !31

L48:                                              ; preds = %L48.loopexit, %pass
  %.not11 = icmp eq i64 %value_phi3, %6, !dbg !31
  %10 = add nuw nsw i64 %value_phi3, 1, !dbg !34
  br i1 %.not11, label %L60.loopexit, label %idxend, !dbg !35
...
fail:                                             ; preds = %idxend
  tail call void @jl_throw({} addrspace(12)* addrspacecast ({}* inttoptr (i64 140589825318400 to {}*) to {} addrspace(12)*)), !dbg !28
  unreachable, !dbg !28
...
pass:                                             ; preds = %idxend
  ...
  %.not8.not = icmp eq i64 %17, 0, !dbg !40
  br i1 %.not8.not, label %L48, label %pass13.preheader, !dbg !30

pass13.preheader:                                 ; preds = %pass
  ...
  br label %idxend17, !dbg !46

idxend17:                                         ; preds = %idxend17, %pass13.preheader
  %value_phi8 = phi i64 [ %25, %idxend17 ], [ 1, %pass13.preheader ]
  ...
  %.not10 = icmp eq i64 %value_phi8, %17, !dbg !31
  %25 = add nuw nsw i64 %value_phi8, 1, !dbg !34
  br i1 %.not10, label %L48.loopexit, label %idxend17, !dbg !35
}

define nonnull {} addrspace(10)* @"jfptr_nestedloop_1!_149"({} addrspace(10)* nocapture readnone %0, {} addrspace(10)** nocapture readonly %1, i32 %2) local_unnamed_addr #1 {
top:
  ...
  tail call void @"julia_nestedloop_1!_148"({} addrspace(10)* %4, i64 signext %9) #0
  ret {} addrspace(10)* addrspacecast ({}* inttoptr (i64 140589999734792 to {}*) to {} addrspace(10)*)
}
...
!4 = !{}
!5 = distinct !DISubprogram(name: "nestedloop_1!", linkageName: "julia_nestedloop_1!_148", scope: null, file: !3, line: 45, type: !6, scopeLine: 45, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
