...
define nonnull {} addrspace(10)* @japi1_foo_161({} addrspace(10)* nocapture readnone %0, {} addrspace(10)** %1, i32 %2) local_unnamed_addr #0 !dbg !5 {
top:
...
!4 = !{}
!5 = distinct !DISubprogram(name: "foo", linkageName: "japi1_foo_161", scope: null, file: !3, line: 3, type: !6, scopeLine: 3, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
