...
define nonnull {} addrspace(10)* @julia_foo_163({} addrspace(10)* nonnull readonly returned align 16 dereferenceable(40) %0, i64 signext %1, i64 signext %2, i64 signext %3, i64 signext %4, i64 signext %5, i64 signext %6) local_unnamed_addr #0 !dbg !5 {
top:
...
define nonnull {} addrspace(10)* @jfptr_foo_164({} addrspace(10)* nocapture readnone %0, {} addrspace(10)** nocapture readonly %1, i32 %2) local_unnamed_addr #1 {
top:
  ...
  %35 = tail call nonnull {} addrspace(10)* @julia_foo_163({} addrspace(10)* %4, i64 signext %9, i64 signext %14, i64 signext %19, i64 signext %24, i64 signext %29, i64 signext %34) #0
...
!4 = !{}
!5 = distinct !DISubprogram(name: "foo", linkageName: "julia_foo_163", scope: null, file: !3, line: 3, type: !6, scopeLine: 3, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
