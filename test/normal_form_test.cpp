...
//         std::cout << "\n\n\n====\n\nH=\n" << H3 << "\nU=\n" << U3 <<
//         std::endl; EXPECT_TRUE(isHNF(H3)); EXPECT_TRUE(H3 == U3 * A);
//     }
//     {
//         IntMatrix A(2, 3);
//         A(0, 0) = -3;
...
//     IntMatrix B =
//         stringToIntMatrix("[-6 86 -27 46 0 -15; -90 -81 91 44 -2 78; 4 -54
//         -98 "
...
//     IntMatrix D = stringToIntMatrix("[-2 -2 -1 -2 -1; 0 -8 -6 -2 0; 0 0 -12
//     -8 "
