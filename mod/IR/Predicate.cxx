...
struct Intersection {
  ...
  [[nodiscard]] auto intersect(size_t index,
                               Relation value) const -> Intersection {
    invariant(index < 32);
    index += index;
  ...
  operator&(Intersection other) const -> Intersection {
  ...
  [[nodiscard]] constexpr auto
  getConflict(Intersection other) const -> Intersection {
